...
Staging (`staging`): **v7.75.1**, awaiting the owner's review.
...
| `tools/*.js` | Test suite (6 files, 893 assertions). Plain Node, no framework. |
| `CHANGE-LOG-v*.md` | Per-release write-ups (v7.67, v7.69–v7.75.1). Longer-form companions to the in-file changelog comment block. |
